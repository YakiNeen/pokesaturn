...
; entries correspond to PAL_* constants
	...
	RGB 30,31,29, 28,20,15, 21,00,04, 03,02,02 ; PAL_TOWNMAP
IF DEF(_RED)
...
ENDC
	...
	RGB 28,28,28, 23,19,13, 14,12,17, 04,04,04 ; PAL_SHINYMEWMON
	RGB 28,28,28, 16,18,21, 10,12,18, 04,04,04 ; PAL_SHINYBLUEMON
	RGB 28,28,28, 22,15,16, 17,02,05, 04,04,04 ; PAL_SHINYREDMON
	RGB 28,28,28, 15,20,20, 05,16,16, 04,04,04 ; PAL_SHINYCYANMON
	RGB 28,28,28, 23,15,19, 14,04,12, 04,04,04 ; PAL_SHINYPURPLEMON
	RGB 28,28,28, 20,17,18, 18,13,11, 04,04,04 ; PAL_SHINYBROWNMON
	RGB 28,28,28, 23,21,16, 12,12,10, 04,04,04 ; PAL_SHINYGREENMON
	RGB 28,28,28, 21,25,29, 30,22,23, 04,04,04 ; PAL_SHINYPINKMON
	RGB 28,28,28, 26,23,16, 29,14,09, 04,04,04 ; PAL_SHINYYELLOWMON
	RGB 28,28,28, 18,18,18, 10,10,10, 04,04,04 ; PAL_SHINYGREYMON
