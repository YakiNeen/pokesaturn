MapSongBanks::
	...
	db MUSIC_MART, BANK(Music_Mart) ; VIRIDIAN_MART
	...
	db MUSIC_ROUTES1, BANK(Music_Routes1) ; VIRIDIAN_FOREST_NORTH_GATE
	db MUSIC_ROUTES1, BANK(Music_Routes1) ; ROUTE_2_TRADE_HOUSE
	db MUSIC_ROUTES1, BANK(Music_Routes1) ; ROUTE_2_GATE
	db MUSIC_ROUTES1, BANK(Music_Routes1) ; VIRIDIAN_FOREST_SOUTH_GATE
	...
	db MUSIC_MART, BANK(Music_Mart) ; PEWTER_MART
	...
	db MUSIC_MART, BANK(Music_Mart) ; CERULEAN_MART
	...
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; ROUTE_5_GATE
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; UNDERGROUND_PATH_ROUTE_5
	db MUSIC_CITIES2, BANK(Music_Cities2) ; DAYCARE
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; ROUTE_6_GATE
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; UNDERGROUND_PATH_ROUTE_6
	db MUSIC_VERMILION, BANK(Music_Vermilion) ; UNDERGROUND_PATH_ROUTE_6_COPY
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; ROUTE_7_GATE
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; UNDERGROUND_PATH_ROUTE_7
	db MUSIC_CELADON, BANK(Music_Celadon) ; UNDERGROUND_PATH_ROUTE_7_COPY
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; ROUTE_8_GATE
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; UNDERGROUND_PATH_ROUTE_8
	...
	db MUSIC_ROUTES4, BANK(Music_Routes4) ; ROUTE_11_GATE_1F
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; DIGLETTS_CAVE_ROUTE_11
	db MUSIC_ROUTES4, BANK(Music_Routes4) ; ROUTE_11_GATE_2F
	db MUSIC_ROUTES4, BANK(Music_Routes4) ; ROUTE_12_GATE_1F
	...
	db MUSIC_MART, BANK(Music_Mart) ; VERMILION_MART
	...
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; UNUSED_MAP_6D
	...
	db MUSIC_MART, BANK(Music_Mart) ; CELADON_MART_1F
	db MUSIC_MART, BANK(Music_Mart) ; CELADON_MART_2F
	db MUSIC_MART, BANK(Music_Mart) ; CELADON_MART_3F
	db MUSIC_MART, BANK(Music_Mart) ; CELADON_MART_4F
	db MUSIC_MART, BANK(Music_Mart) ; CELADON_MART_ROOF
	db MUSIC_MART, BANK(Music_Mart) ; CELADON_MART_ELEVATOR
	...
	db MUSIC_MART, BANK(Music_Mart) ; CELADON_MART_5F
	...
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; POKEMON_TOWER_1F
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; POKEMON_TOWER_2F
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; POKEMON_TOWER_3F
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; POKEMON_TOWER_4F
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; POKEMON_TOWER_5F
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; POKEMON_TOWER_6F
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; POKEMON_TOWER_7F
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; MR_FUJIS_HOUSE
	db MUSIC_MART, BANK(Music_Mart) ; LAVENDER_MART
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; LAVENDER_CUBONE_HOUSE
	db MUSIC_MART, BANK(Music_Mart) ; FUCHSIA_MART
	...
	db MUSIC_VERMILION, BANK(Music_Vermilion) ; VERMILION_OLD_ROD_HOUSE
	...
	db MUSIC_MART, BANK(Music_Mart) ; CINNABAR_MART
	db MUSIC_MART, BANK(Music_Mart) ; CINNABAR_MART_COPY
	...
	db MUSIC_ROUTES4, BANK(Music_Routes4) ; ROUTE_15_GATE_1F
	db MUSIC_ROUTES4, BANK(Music_Routes4) ; ROUTE_15_GATE_2F
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; ROUTE_16_GATE_1F
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; ROUTE_16_GATE_2F
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; ROUTE_16_FLY_HOUSE
	db MUSIC_ROUTES4, BANK(Music_Routes4) ; ROUTE_12_SUPER_ROD_HOUSE
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; ROUTE_18_GATE_1F
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; ROUTE_18_GATE_2F
	...
	db MUSIC_ROUTES4, BANK(Music_Routes4) ; ROUTE_12_GATE_2F
	...
	db MUSIC_CITIES2, BANK(Music_Cities2) ; CERULEAN_BADGE_HOUSE
	...
	db MUSIC_LAVENDER, BANK(Music_Lavender) ; AGATHAS_ROOM
